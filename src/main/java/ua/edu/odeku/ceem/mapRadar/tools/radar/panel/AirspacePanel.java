...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadButtonText$$$(buttonCreate, ResourceBundle.getBundle("bundles/strings").getString("button_create"));
        panel2.add(buttonCreate, cc.xy(1, 3));
        buttonRemove = new JButton();
        this.$$$loadButtonText$$$(buttonRemove, ResourceBundle.getBundle("bundles/strings").getString("button_remove"));
        panel2.add(buttonRemove, cc.xy(3, 3));
        buttonClearSelection = new JButton();
        this.$$$loadButtonText$$$(buttonClearSelection, ResourceBundle.getBundle("bundles/strings").getString("button_clear_selection"));
        panel2.add(buttonClearSelection, cc.xy(5, 3));
        final JScrollPane scrollPane1 = new JScrollPane();
        scrollPane1.setToolTipText(ResourceBundle.getBundle("bundles/strings").getString("table_radarManager_airspace_table_toolTip"));
