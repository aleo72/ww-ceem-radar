...
public class ViewGeoNamePanel implements CeemPanel {
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("bundles/strings").getString("label_find-for-Name"));
        panel3.add(label1, cc.xy(3, 1));
        textField = new JTextField();
        textField.setColumns(10);
        panel3.add(textField, cc.xy(5, 1, CellConstraints.FILL, CellConstraints.DEFAULT));
        editButton = new JButton();
        this.$$$loadButtonText$$$(editButton, ResourceBundle.getBundle("bundles/strings").getString("button_edit"));
        panel3.add(editButton, cc.xy(1, 1));
        refreshButton = new JButton();
        this.$$$loadButtonText$$$(refreshButton, ResourceBundle.getBundle("bundles/strings").getString("button_refresh"));
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("bundles/strings").getString("label_importGeoName_country"));
        ...
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle("bundles/strings").getString("label_importGeoName_feature-class"));
        ...
        this.$$$loadLabelText$$$(label4, ResourceBundle.getBundle("bundles/strings").getString("label_importGeoName_feature-code"));
