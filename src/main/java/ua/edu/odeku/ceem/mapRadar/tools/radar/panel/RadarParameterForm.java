...
// DO NOT EDIT OR ADD ANY CODE HERE!
    ...
    private void $$$setupUI$$$() {
        ...
        this.$$$loadLabelText$$$(label1, ResourceBundle.getBundle("bundles/label").getString("airspace_name"));
        ...
        this.$$$loadLabelText$$$(label2, ResourceBundle.getBundle("bundles/label").getString("airspace_altitude"));
        attributePanel.add(label2, cc.xy(1, 2));
        altitudeSpinner = new JSpinner();
        altitudeSpinner.setMaximumSize(new Dimension(400, 400));
        attributePanel.add(altitudeSpinner, cc.xy(3, 2, CellConstraints.FILL, CellConstraints.DEFAULT));
        final JLabel label3 = new JLabel();
        this.$$$loadLabelText$$$(label3, ResourceBundle.getBundle("bundles/label").getString("airspace_durationPulse"));
        attributePanel.add(label3, cc.xy(1, 4));
        durationPulseSpinner = new JSpinner();
        durationPulseSpinner.setMaximumSize(new Dimension(400, 400));
        attributePanel.add(durationPulseSpinner, cc.xy(3, 4, CellConstraints.FILL, CellConstraints.DEFAULT));
        final JLabel label4 = new JLabel();
        this.$$$loadLabelText$$$(label4, ResourceBundle.getBundle("bundles/label").getString("airspace_wavelength"));
        attributePanel.add(label4, cc.xy(1, 6));
        final JLabel label5 = new JLabel();
        this.$$$loadLabelText$$$(label5, ResourceBundle.getBundle("bundles/label").getString("airspace_antennaDiameter"));
        attributePanel.add(label5, cc.xy(1, 8));
        final JLabel label6 = new JLabel();
        this.$$$loadLabelText$$$(label6, ResourceBundle.getBundle("bundles/label").getString("airspace_pulsePower"));
        attributePanel.add(label6, cc.xy(1, 10));
        waveLengthSpinner = new JSpinner();
        waveLengthSpinner.setMaximumSize(new Dimension(400, 400));
        ...
        antennaDiameterSpinner.setMaximumSize(new Dimension(400, 400));
        ...
        pulsePowerSpinner.setMaximumSize(new Dimension(400, 400));
        attributePanel.add(pulsePowerSpinner, cc.xy(3, 10, CellConstraints.FILL, CellConstraints.DEFAULT));
        final JLabel label7 = new JLabel();
        this.$$$loadLabelText$$$(label7, ResourceBundle.getBundle("bundles/label").getString("airspace_reflectivityMeteoGoals"));
        attributePanel.add(label7, cc.xy(1, 12));
        final JLabel label8 = new JLabel();
        this.$$$loadLabelText$$$(label8, ResourceBundle.getBundle("bundles/label").getString("airspace_attenuation"));
        attributePanel.add(label8, cc.xy(1, 14));
        final JLabel label9 = new JLabel();
        this.$$$loadLabelText$$$(label9, ResourceBundle.getBundle("bundles/label").getString("airspace_radius"));
        attributePanel.add(label9, cc.xy(1, 16));
        final JLabel label10 = new JLabel();
        this.$$$loadLabelText$$$(label10, ResourceBundle.getBundle("bundles/label").getString("airspace_grainFactor"));
        attributePanel.add(label10, cc.xy(1, 18));
        reflectivityMeteoGoalsSpinner = new JSpinner();
        reflectivityMeteoGoalsSpinner.setMaximumSize(new Dimension(400, 400));
